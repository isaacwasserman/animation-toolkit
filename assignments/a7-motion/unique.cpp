...
{
public:
   std::string BVHPath = "../motions/Imported/jumpnroll.bvh";
   ...
   void scene() {
      lookAt(vec3(sin(elapsedTime()) * 300, 100, cos(elapsedTime()) * 300), vec3(0));
      setColor(vec3(0,1,0));
      drawCube(vec3(0),vec3(9999,1,9999));
      setColor(vec3(0));
      drawCube(vec3(-75,0,0),vec3(57));
